...
import { Section, Modal, AddTaskForm, ConfirmForm, EditBoardForm, Loading } from '../../components';
...
function BoardPage() {
    ...
    const [isEditBoardModalActive, setIsEditBoardModalActive] = useState<boolean>(false);
    ...
    function onDropHandler(
        ...
        e.stopPropagation();
        if (!board) return;
        const updatedSections: ISection[] = JSON.parse(JSON.stringify(board.sections));
        ...
        if (currentTask && currentSection?.tasks && destinationSection.tasks) {
            ...
            const destinationTaskIndex = destinationSection.tasks.indexOf(destinationTask);
            if (
    ...
    async function onDropTaskHandler(
        ...
        e.preventDefault();
        if (board === null || currentTask === null || currentSection === null) return;
    ...
    return loading ? (
        ...
        <div className="board">
            ...
            <Modal active={isEditBoardModalActive} setActive={setIsEditBoardModalActive}>
                <EditBoardForm setActiveModal={setIsEditBoardModalActive} board={board} />
            </Modal>
            <Modal active={isModalActive} setActive={setIsModalActive}>
                <AddTaskForm setActiveModal={setIsModalActive} section={newTaskSection} />
            </Modal>
